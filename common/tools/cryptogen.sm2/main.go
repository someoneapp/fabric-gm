...
import (
	...
	"github.com/hyperledger/fabric/common/tools/cryptogen.sm2/metadata"
	"github.com/hyperledger/fabric/common/tools/cryptogen.sm2/msp"
)
...
//command line flags
var (
	app = kingpin.New("cryptogen.sm2", "Utility for generating Hyperledger Fabric key material")
